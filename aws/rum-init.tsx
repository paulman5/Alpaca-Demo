...
export function RumInit() {
  useEffect(() => {
    try {
      ...
      const APPLICATION_VERSION = process.env.NEXT_PUBLIC_AWS_RUM_APP_VERSION || "1.0.0";
      ...
      const config: AwsRumConfig = {
        sessionSampleRate: Number(process.env.NEXT_PUBLIC_AWS_RUM_SAMPLE_RATE || 0.1),
        identityPoolId: process.env.NEXT_PUBLIC_AWS_RUM_IDENTITY_POOL_ID || "",
        endpoint:
          process.env.NEXT_PUBLIC_AWS_RUM_ENDPOINT || "https://dataplane.rum.us-east-1.amazonaws.com",
