...
export default function StockChart({ data, ticker, height = 400 }: StockChartProps) {
  ...
  useEffect(() => {
    ...
    const priceSeries = chart.addLineSeries({ color: "#a7c6ed", lineWidth: 2 });
  ...
  if (!data || data.length === 0) {
    return (
      <div className="flex items-center justify-center bg-gray-50 rounded-none" style={{ height: `${height}px` }}>
      ...
      <CardHeader className="border-b">
        <div className="flex flex-col gap-1">
          <div className="mb-1">
            ...
            <CardDescription>Professional TradingView-style chart</CardDescription>
          </div>
